...
int main()
{
	...
	try
	{
		...
		const size_t numb_rows = 5000;
		const size_t numb_cols = 5000;
		...
		std::cout << "Average time = " << duration.count() / 1000.0 << "ms" << std::endl;
		...
		std::cout << "Average time = " << duration1.count() / 1000.0 << "ms" << std::endl;
